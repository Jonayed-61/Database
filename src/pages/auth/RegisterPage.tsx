...
const RegisterPage: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      const registerData: RegisterData = { ...data, role: data.role as UserRole, profilePicture: profilePicture || undefined };
      ...
      case 3:
        return (
          <div className="space-y-6 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">Add a face to your academic profile</p>
